...
/// expansion rules. The resolved inode is delegated directly to [`append_file_blocks_journaled`],
/// so allocator ownership, inode growth, data publication, WAL ordering, recovery, and journal
/// capacity remain centralized in the existing inode-ID-based append primitive.
///
...
///
/// # Errors
/// Propagates pathname lookup errors and all [`append_file_blocks_journaled`] validation or durable
/// I/O errors, including a resolved non-file inode, an empty append, allocator exhaustion, and
