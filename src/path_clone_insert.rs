...
/// [`clone_file_blocks_insert_journaled`] validation or durable I/O errors, including non-file
/// endpoints, an empty or out-of-range source interval, an out-of-range destination insertion
/// boundary, allocator exhaustion, ownership disagreement, or insufficient journal capacity.
