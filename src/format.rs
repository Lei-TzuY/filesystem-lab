...
impl Superblock {
    /// Creates a version-7 superblock using the default metadata reservations.
    ///
    /// # Errors
    ///
    ...
    /// Creates a version-7 superblock with an explicit journal reservation.
    ///
    /// # Errors
    ///
    ...
    /// Creates a version-7 superblock with explicit journal and inode reservations.
    ///
    ...
    /// Creates a version-7 superblock with explicit journal, inode, and directory reservations.
    ///
    ...
    /// Decodes and validates a version-7 superblock block.
    ///
    /// # Errors
    ///
    /// Returns `InvalidData` for unsupported versions, malformed geometry, or non-zero reserved
    /// bytes. Version-6 and older images are intentionally not reinterpreted as version 7.
