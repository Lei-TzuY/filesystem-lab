...
/// delegated directly to [`replace_file_blocks_journaled`], preserving its allocation, inode-resize,
/// data-publication, WAL recovery, and checkpoint semantics.
///
...
/// [`replace_file_blocks_journaled`] validation or durable I/O errors.
