...
///
/// Source and destination both follow intermediate and final symbolic links under the repository-wide
/// bounded expansion rules. Resolved inode IDs are delegated to
/// [`clone_file_blocks_splice_journaled`], preserving its single WAL-backed allocator/inode/data
/// publication path and recovery contract.
///
...
///
/// # Errors
/// Propagates pathname lookup errors and all [`clone_file_blocks_splice_journaled`] validation or
/// durable I/O errors, including non-file endpoints, empty or out-of-range intervals, identical
/// resolved endpoints, allocator exhaustion, ownership disagreement, or insufficient journal
/// capacity.
