...
///
/// # Errors
/// Propagates pathname lookup errors and all [`clone_file_blocks_replace_journaled`] validation or
/// durable I/O errors, including non-file endpoints, an empty or out-of-range interval, identical
