...
/// resolved inode is delegated directly to [`collapse_file_block_range_journaled`], keeping allocator
/// ownership validation, WAL publication, crash recovery, and checkpoint semantics centralized in
...
/// [`collapse_file_block_range_journaled`] validation or durable I/O errors, including a resolved
/// non-file inode, an empty range, an out-of-range interval, allocator ownership disagreement, or
