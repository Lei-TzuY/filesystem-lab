...
#[test]
fn copy_range_recovers_committed_source_symlink_before_resolving_it() {
    ...
    for crash_at in 0..operations {
        ...
        copy_file_range_at_path_journaled(
            ...
            path_range("/dst", 0, BLOCK_SIZE - 2),
            4,
        )
        .unwrap();

        assert_eq!(
            read_file_range_at_path(&mut device, &superblock, "/dst", 0, BLOCK_SIZE - 2, 4)
                .unwrap(),
