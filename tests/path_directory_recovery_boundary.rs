...
#[test]
fn directory_listing_recovers_committed_symlink_before_resolution() {
    ...
    for crash_at in 0..operations {
        ...
        assert_eq!(
            list_directory_at_path(&mut device, &superblock, "/dir_alias").unwrap(),
            vec![PathDirectoryEntry {
                name: "child".to_owned(),
                inode_id: 3,
                kind: InodeKind::File,
            }]
