...
fn setup_without_file_alias() -> (CrashDevice, Superblock, [u64; 3]) {
...
#[test]
fn insert_recovers_committed_final_symlink_before_resolving_it() {
    ...
    for crash_at in 0..operations {
        let (mut device, superblock, old_blocks) = setup_without_file_alias();
        ...
        let (inserted, _) = insert_alias(&mut device, &superblock).unwrap();
