...
#[test]
fn clone_replace_recovers_committed_source_symlink_before_resolving_it() {
    ...
    for crash_at in 0..operations {
        ...
        let (new_blocks, displaced_blocks, _) = clone_file_blocks_replace_at_path_journaled(
            &mut device,
            &superblock,
        ...
        assert_eq!(displaced_blocks.len(), 2);
        assert_eq!(
