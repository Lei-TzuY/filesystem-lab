...
#[test]
fn inserts_cloned_blocks_through_intermediate_and_final_symlink_paths() {
...
#[test]
fn rejects_invalid_path_clone_insert_without_publication() {
    let (mut device, superblock) = setup();
...
#[test]
fn every_path_clone_insert_crash_point_recovers_old_or_complete_new_state() {
