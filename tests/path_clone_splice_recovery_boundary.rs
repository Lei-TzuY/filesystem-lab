...
#[test]
fn clone_splice_recovers_committed_source_symlink_before_resolving_it() {
    ...
    for crash_at in 0..operations {
        ...
        let (new_blocks, released_blocks, _) = clone_file_blocks_splice_at_path_journaled(
            &mut device,
            &superblock,
            range("/src_alias", 0, 2),
            range("/dst", 1, 1),
        ...
        assert_eq!(released_blocks.len(), 1);
        assert_eq!(
